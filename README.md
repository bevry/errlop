...
``` typescript
import pkg from 'https://unpkg.com/errlop@^3.12.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/errlop/^3.12.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/errlop@^3.12.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/errlop@3.12.0'
</script>
```
