...
``` typescript
import pkg from 'https://unpkg.com/errlop@^4.0.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/errlop@^4.0.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/errlop@^4.0.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/errlop@4.0.0'
</script>
```
